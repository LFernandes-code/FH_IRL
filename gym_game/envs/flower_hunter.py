...
#################################################################################################################
#								                                   		                                        #
#      Uncomment the following lines for playing with an agent and predicting one of the PAD dimensions         #
#                                                                                                               #
#										                                                                        #
#################################################################################################################
	...
	# # (explore_preference, flower_preference, kill_preference, coin_preference, cake_preference, randomness, cake_health_influence, x_preference, y_preference, bvd_parameter)

	# parameters = [None, 0, 70, 78, 0, None, 78, None, None, 100]




	# trained_model_file = 'Trained PAD Predictors/trained_forest_Arousal.pkl'
